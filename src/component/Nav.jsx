    ...
    <div className="bg-base-100">
      <div className="navbar container mx-auto ">
        <div className="navbar-start">
          ...
          <Link
            to="/"
            className=" logo_font text-nowrap  md:text-2xl border-b-black border-b-2"
          >
            <span className="text-blue-700">Freelance</span> Frontier
          </Link>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu-horizontal gap-x-6 items-center">
            <li>
              <NavLink
                className={({ isActive }) =>
                  isActive
          ...
          {user ? (
            <div className="dropdown dropdown-end z-40 ">
              ...
              >
                ...
                <li>
                  <NavLink to="/mysubmitted">My submitted</NavLink>
                </li>
                <li>
